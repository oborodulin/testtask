...
using Animatable = TestTask.Classes.DataModels.Animatable;
using IAnimatable = TestTask.Classes.DataModels.Interfaces.IAnimatable;

namespace TestTask.Classes.Views.Panels
{
    /// <summary>
