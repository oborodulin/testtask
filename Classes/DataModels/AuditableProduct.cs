...
namespace TestTask.Classes.DataModels
{
    /// <summary>
    /// Represents a validatable product in the application.
    /// </summary>
    public class AuditableProduct : BaseNotifyValidationModelGeneric<AuditableProduct>, IAuditable
    {
        ...
        /// <summary>
        /// Initializes a new empty AuditableProduct object.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new AuditableProduct object with the value provided by the input parameter.
        /// </summary>
        /// <param name="product">The ThinProduct instance to initialize the AuditableProduct object from.</param>
        ...
        /// <summary>
        /// Specifies whether the property values of the AuditableProduct object are equal to the property values of the object specified by the otherProduct input parameter, or not.
        /// </summary>
