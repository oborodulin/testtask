...
namespace TestTask.Classes.DataModels
{
    ...
    /// </summary>
    /// <typeparam name="T">The type of the data model object requiring validation support.</typeparam>
    public abstract class BaseNotifyValidationModelGeneric<T> : BaseSynchronizableDataModel<T>, INotifyPropertyChanged, INotifyDataErrorInfo where T : BaseDataModel, ISynchronizableDataModel<T>, new()
    {
        ...
        /// </summary>
        protected BaseNotifyValidationModelGeneric()
        {
        ...
        /// <summary>
        /// Gets or sets the ValidationLevel member of the BaseNotifyValidationModelGeneric object, that specifies the level of validation required on it.
        /// </summary>
