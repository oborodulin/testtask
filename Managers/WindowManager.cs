...
using MessageBoxButton = TestTask.Classes.DataModels.Enums.MessageBoxButton;
using MessageBoxButtonSelection = TestTask.Classes.DataModels.Enums.MessageBoxButtonSelection;
using MessageBoxIcon = TestTask.Classes.DataModels.Enums.MessageBoxIcon;
